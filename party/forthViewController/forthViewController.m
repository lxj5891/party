...
- (void)viewDidLoad
{
    ...
    [super viewDidLoad];
     self.tableV=[[UITableView alloc]initWithFrame:mainscreen style:UITableViewStyleGrouped];
    self.tableV.dataSource=self;
    self.tableV.delegate=self;
    self.tableV.backgroundView=nil;
    self.tableV.backgroundColor=[UIColor colorWithRed:248.0/255 green:248.0/255 blue:248.0/255 alpha:1];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.backgroundView=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"UPview@2x.png.png"]];
    if (section==0) {

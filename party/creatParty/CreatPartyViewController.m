...
- (void)viewDidLoad
{
    ...
    if (self.keyboardToolbar == nil) {
        self.keyboardToolbar = [[[UIToolbar alloc] initWithFrame:CGRectMake(0, 0, self.view.bounds.size.width, 38.0f)]autorelease];
...
-(void)CallBack:(NSMutableArray *)muArr
{
    ...
    for (int i=0; i<[friengArr count]; i++) {
        UIImageView *imageView=[[UIImageView alloc]initWithFrame:CGRectMake(90+40*i, 144, 35, 35)];

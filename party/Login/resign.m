...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        //*****************************密码*************************************
        field2=[[[UITextField alloc]initWithFrame:CGRectMake(44, 52, 267, 40.5)]autorelease];
        ...
        button1.frame=CGRectMake(0, 100, 88, 23);
        ...
        button2.frame=CGRectMake(225, 97, 33, 24.5);
        [button2 setBackgroundImage:[UIImage imageNamed:@"sina@2x.png"] forState:UIControlStateNormal];
        [button2 setBackgroundImage:[UIImage imageNamed:@"sinaing@2x.png"] forState:UIControlStateSelected];
